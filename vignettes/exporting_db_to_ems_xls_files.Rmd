---
title: "Spatiotemporal DB schema and exporting into EMS format"
author: package author
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Spatiotemporal DB schema and exporting into EMS format}
...
In absence of a specific R or packages or command-lina APIs, some parts of tHe current dataset can be uploaded EMS (https://aquaknow.jrc.ec.europa.eu/document/ems-tool) through suitable MIcrosfoft Excel Files. Due to the physical limitation on the number of rows of a Microsoft Excel file the example exports only thre weather data of Morocco just inserted into $db$.  


requires to uplad data throwgh two 
```{r, echo=TRUE, results='asis'}
